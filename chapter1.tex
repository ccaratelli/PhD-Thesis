...
Moreover, the UiO-66 bricks can be reversibly dehydrated by thermal treatment at temperatures above 300 $^{\circ}$C. Up to two water molecules can be removed from the inorganic \ce{Zr6O4(OH)4} SBU, yielding a \ce{Zr6O6} brick, where the zirconium atoms have an average coordination of 7. 
