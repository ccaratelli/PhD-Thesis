...
%\hspace{-\parindent}Advanced Molecular Simulations to Study Defects and
%Nature of Active Sites in Zirconium Based Metal--Organic
%Frameworks for Catalysis \\

%\hspace{-\parindent}Geavanceerde moleculaire simulaties voor het bestuderen
%van defecten en de aard van actieve centra in
%zirconium gebaseerde metaal--organische\\ roosters voor katalyse \\


%\vspace{0.5cm}
%\hspace{-\parindent}Julianna Hajek
...
%  \hspace{-\parindent}Academic year 2017--2018
%\end{minipage}
...
%  credits CMM
\include{examencommissie}                    %chiara decomment this
